public class CryptoConstant
{
    ...
    public static byte[] bUserKey = new byte[128] { // 16 * 8
    ...
    public static byte[] WZ_GMS_IV = new byte[4] { 0x4D, 0x23, 0xC7, 0x2B };

    public static byte[] WZ_MSEA_IV = new byte[4] { 0xB9, 0x7D, 0x63, 0xE9 };
